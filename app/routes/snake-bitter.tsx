...
export default function SnakeBitter() {
  return (
    <main dir="rtl">
      ...
      <div className="pt-12 justify-center items-center flex flex-col content-center">
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-amber-200">
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-blue-200">
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-fuchsia-200">
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-indigo-200">
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-lime-200">
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-yellow-200">
          <div>
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-green-200">
        ...
        <p className="mb-12 px-12 text-gray-600 rounded-2xl max-w-2xl py-6 text-4xl whitespace-pre-wrap bg-pink-200">
          <div>
